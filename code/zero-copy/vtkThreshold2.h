...
=========================================================================*/
// .NAME vtkThreshold2 - extracts cells where scalar value in cell satisfies threshold criterion
// .SECTION Description
// vtkThreshold2 is a filter that extracts cells from any dataset type that
...
// .SECTION See Also
// vtkThreshold2Points vtkThreshold2TextureCoords

#ifndef vtkThreshold2_h
#define vtkThreshold2_h
...
class vtkThreshold2 : public vtkUnstructuredGridAlgorithm
{
public:
  static vtkThreshold2 *New();
  vtkTypeMacro(vtkThreshold2,vtkUnstructuredGridAlgorithm);
...
protected:
  ...
  //BTX
  int (vtkThreshold2::*ThresholdFunction)(double s);
  //ETX
...
private:
  vtkThreshold2(const vtkThreshold2&);  // Not implemented.
  void operator=(const vtkThreshold2&);  // Not implemented.
};
