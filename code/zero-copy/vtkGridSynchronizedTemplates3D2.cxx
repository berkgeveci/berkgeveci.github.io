/*=========================================================================
  ...
  Module:    vtkGridSynchronizedTemplates3D2.cxx
...
vtkStandardNewMacro(vtkGridSynchronizedTemplates3D2);
...
vtkGridSynchronizedTemplates3D2::vtkGridSynchronizedTemplates3D2()
{
...
//----------------------------------------------------------------------------
void vtkGridSynchronizedTemplates3D2::SetInputMemoryLimit(
...
unsigned long vtkGridSynchronizedTemplates3D2::GetMTime()
{
...
//----------------------------------------------------------------------------
static void vtkGridSynchronizedTemplates3D2InitializeOutput(
  int *ext,
  int precision,
                 ...
                 InputIterator points)
{
  ...
  InputIterator inPtPtrX, inPtPtrY, inPtPtrZ;
  InputIterator p0, p1, p2, p3;
  ...
  vtkGridSynchronizedTemplates3D2InitializeOutput(
                 ...
                 vtkPolyData *output, vtkDataArray *inScalars, bool outputTriangles)
{
  ...
  switch(pts->GetDataType())
    ...
    vtkDataArrayIteratorMacro(pts,
      ContourGrid(self, exExt, scalars, input, output, static_cast<vtkDAValueType*>(0), inScalars, outputTriangles, vtkDABegin));
    }
}

//----------------------------------------------------------------------------
// Contouring filter specialized for images (or slices from images)
void vtkGridSynchronizedTemplates3D2::ThreadedExecute(vtkStructuredGrid *input,
...
//----------------------------------------------------------------------------
int vtkGridSynchronizedTemplates3D2::RequestUpdateExtent(
...
//----------------------------------------------------------------------------
int vtkGridSynchronizedTemplates3D2::FillInputPortInformation(
...
//----------------------------------------------------------------------------
void vtkGridSynchronizedTemplates3D2::PrintSelf(ostream& os, vtkIndent indent)
{
...
//----------------------------------------------------------------------------
int vtkGridSynchronizedTemplates3D2::RequestData(
  vtkInformation *vtkNotUsed(request),
  vtkInformationVector **inputVector,
  vtkInformationVector *outputVector)
{
