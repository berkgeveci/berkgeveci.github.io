...
vtkStandardNewMacro(vtkThreshold2);

// Construct with lower threshold=0, upper threshold=1, and threshold
// function=upper AllScalars=1.
vtkThreshold2::vtkThreshold2()
{
  this->LowerThreshold         = 0.0;
  this->UpperThreshold         = 1.0;
  this->AllScalars             = 1;
  this->AttributeMode          = -1;
  this->ThresholdFunction      = &vtkThreshold2::Upper;
...
void vtkThreshold2::ThresholdByLower(double lower)
{
  if ( this->LowerThreshold != lower ||
       this->ThresholdFunction != &vtkThreshold2::Lower)
    {
...
void vtkThreshold2::ThresholdByUpper(double upper)
{
...
void vtkThreshold2::ThresholdBetween(double lower, double upper)
{
  if ( this->LowerThreshold != lower || this->UpperThreshold != upper ||
       this->ThresholdFunction != &vtkThreshold2::Between)
    {
    this->LowerThreshold = lower;
    this->UpperThreshold = upper;
    this->ThresholdFunction = &vtkThreshold2::Between;
  ...
  vtkInformationVector *outputVector)
{
  ...
  if (this->AttributeMode != -1)
    {
    vtkErrorMacro(<<"You have set the attribute mode on vtkThreshold2. This method is deprecated, please use SetInputArrayToProcess instead.");
    return 1;
    }
...
int vtkThreshold2::EvaluateCell( vtkDataArray *scalars,vtkIdList* cellPts, int numCellPts )
{
  int c(0);
...
int vtkThreshold2::EvaluateCell( vtkDataArray *scalars, int c, vtkIdList* cellPts, int numCellPts )
{
...
int vtkThreshold2::EvaluateComponents( vtkDataArray *scalars, vtkIdType id )
{
  int keepCell = 0;
  int numComp = scalars->GetNumberOfComponents();
  int c;
...
const char *vtkThreshold2::GetAttributeModeAsString(void)
{
...
const char *vtkThreshold2::GetComponentModeAsString(void)
{
...
void vtkThreshold2::SetPointsDataType(int type)
{
  if(type == VTK_FLOAT)
    {
...
int vtkThreshold2::GetPointsDataType()
{
...
void vtkThreshold2::SetOutputPointsPrecision(int precision)
{
  this->OutputPointsPrecision = precision;
  this->Modified();
}

int vtkThreshold2::GetOutputPointsPrecision() const
{
  return this->OutputPointsPrecision;
}

int vtkThreshold2::FillInputPortInformation(int, vtkInformation *info)
{
  info->Set(vtkAlgorithm::INPUT_REQUIRED_DATA_TYPE(), "vtkDataSet");
  return 1;
}

void vtkThreshold2::PrintSelf(ostream& os, vtkIndent indent)
{
  ...
  if ( this->ThresholdFunction == &vtkThreshold2::Upper )
    {
    os << indent << "Threshold By Upper\n";
    }

  else if ( this->ThresholdFunction == &vtkThreshold2::Lower )
    {
    os << indent << "Threshold By Lower\n";
    }

  else if ( this->ThresholdFunction == &vtkThreshold2::Between )
    {
