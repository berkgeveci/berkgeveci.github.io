...
=========================================================================*/
// .NAME vtkThreshold3 - extracts cells where scalar value in cell satisfies threshold criterion
// .SECTION Description
// vtkThreshold3 is a filter that extracts cells from any dataset type that
...
// .SECTION See Also
// vtkThreshold3Points vtkThreshold3TextureCoords

#ifndef vtkThreshold3_h
#define vtkThreshold3_h
...
{
public:
  static vtkThreshold3 *New();
  vtkTypeMacro(vtkThreshold3,vtkUnstructuredGridBaseAlgorithm);
...
protected:
  ...
  //BTX
  int (vtkThreshold3::*ThresholdFunction)(double s);
  //ETX
...
private:
  vtkThreshold3(const vtkThreshold3&);  // Not implemented.
  void operator=(const vtkThreshold3&);  // Not implemented.
};
